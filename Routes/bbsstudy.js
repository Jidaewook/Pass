...
const bbsstudyModel = require('../Models/bbsstudy');
...
//@route localhost:5000/bbsstudy
//@desc bbsstudy에 새로 등록(post)한 게시물을 데려온다. 
//@auth private


router.get('/', bbsstudyController.bbsstudy_getall);
